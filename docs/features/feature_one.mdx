...
:::info
Draw.io  by default includes an SVG 1.1 compatibility warning.  Due to the nature of the tools used to build a docusaurus site will always show up if you embed a drawing this way.  
...
:::info
Adding the className of drawio will enable constraining the diagram size properly and will also enable the pan and zoom feature for users.

To pan, click and drag.  To zoom, use the mouse wheel. To reset, double click.
:::
...
:::info
All mermaid diagrams should have the pan and zoom feature for users.
:::
